...
public static final float ALTITUDE_SCALAR = 0.04; // 0.01 < x < 1
public static final String GREYSCALE_IMAGE = "venusTopography.jpeg";
public static final int PHOTO_DETAIL = 200; // 5 < x < 1024 (image width)
public static final double RAYLEIGH_STRENGTH = 0.01; // 0.005 < x < 0.1
}